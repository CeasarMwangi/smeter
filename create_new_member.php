...
?>
	...
	<div class="reg_form">
		<div class="form_title">Create New User</div>
		<form action="" method="post">
			...
			<div class="field">
				<label for="phone_no"> User Phone No</label>
				<input type="text" name="phone_no" value="<?php echo Input::get('phone_no');?>" id="phone_no">
			</div>

			<div class="field">
				<label for="meter_id"> Meter ID</label>
				<input type="text" name="meter_id" value="<?php echo Input::get('meter_id');?>" id="meter_id">
			</div>
